    ...
    <x-data-table :headers="$this->headers" :rows="$this->rows" >
        ...
        @interact('actions', $row)
            <flux:dropdown >
                ...
                />
                <flux:menu>
                    @can('pasos-pedales.recepcion-solicitud.review')
                    <flux:menu.item 
                        icon="eye" 
                ...
                @if($this->nav_option == 1)
                    <fieldset class="border-2 p-4 rounded-lg dark:border-gray-500">
                        ...
                        <div class="grid lg:grid-cols-2 gap-4">
                            ...
                            />
                            <flux:input 
                                wire:model="expediente.solicitud.tipo_persona" 
                                label="Tipo persona" 
                                icon="users" 
                                readonly 
                                disabled 
                ...
                @if($this->nav_option == 4)
                    <div>
                        ...
                        <div class="flex justify-evenly">
                            ...
                            <flux:button wire:click="acceptRequest" icon="check" variant="primary" color="sky">Aceptar solicitud</flux:button>
                        </div>
