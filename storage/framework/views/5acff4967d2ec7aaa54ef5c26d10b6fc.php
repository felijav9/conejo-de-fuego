...
<ui-modal <?php echo e($attributes); ?> data-flux-modal>
    ...
    <dialog
        ...
        x-data="fluxModal(<?php echo \Illuminate\Support\Js::from($name)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from(isset($__livewire) ? $__livewire->getId() : null)->toHtml() ?>)"
...
<?php /**PATH C:\laragon\www\proyecto-restaurante\vendor\livewire\flux\src/../stubs/resources/views/flux/modal/index.blade.php ENDPATH**/ ?>